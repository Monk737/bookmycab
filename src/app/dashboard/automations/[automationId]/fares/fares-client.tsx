    ...
    <div>
      <table className="mb-4 min-w-full border border-gray-200 text-sm">
        ...
        <tbody className="divide-y divide-gray-100">
          ...
          {props.rules.map((r) => (
            <tr key={r.id}>
              <td className="px-3 py-2 text-gray-800">{r.vehicle_type}</td>
              <td className="px-3 py-2 text-gray-600">£{Number(r.base_fare).toFixed(2)}</td>
              <td className="px-3 py-2 text-gray-600">£{Number(r.per_mile).toFixed(2)}</td>
