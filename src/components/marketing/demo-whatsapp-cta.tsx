...
export function DemoWhatsAppCta() {
  ...
  return (
    <a
      ...
      className="brut-press brut-focus inline-flex items-center gap-2 border-[3px] border-ink bg-brut-lime px-6 py-3 text-sm font-bold uppercase tracking-[0.04em] text-ink shadow-brut"
    >
